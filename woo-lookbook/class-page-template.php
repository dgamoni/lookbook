...
class Page_Template_Plugin {
	...
	private function __construct() {
		...
		$this->templates = array(
			'lookbook-template.php'     => __( 'LookBook Page Template', $this->plugin_slug ),
			'lookbook-template-full-width.php' => __( 'LookBook Page Template full-width', $this->plugin_slug )
		);
